  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500">Monitor integrations and automation health</p>
      </div>
      ...
      <Card className="p-6">
        <h3 className="text-lg font-semibold mb-4">Airtable Automations</h3>
            ...
            <tbody className="divide-y">
              {automations.map((auto) => (
                <tr key={auto.name}>
                  ...
                  <td className="px-4 py-3 text-sm text-slate-600">{auto.runs}</td>
                  <td className="px-4 py-3 text-sm text-slate-500">{auto.lastRun}</td>
                </tr>
              ))}
            </tbody>
          </table>
